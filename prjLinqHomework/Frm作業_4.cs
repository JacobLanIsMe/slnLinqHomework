    ...
    private void button2_Click(object sender, EventArgs e)
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            var q = (from i in dbContext.Order_Details.AsEnumerable()
                      ...
                      select new { EmployeeID = g.Key, 銷售員銷售總額 = g.Sum(i => i.UnitPrice * Convert.ToDecimal(i.Quantity) * Convert.ToDecimal(1 - i.Discount)) }).OrderByDescending(i=>i.銷售員銷售總額).Take(5);
        ...
        private void button34_Click(object sender, EventArgs e)
        {
            var q = from i in dbContext.Order_Details.AsEnumerable()
                    ...
                    orderby g.Key
                    select new {Year = g.Key, 每年銷售金額 = $"{g.Sum(i => i.UnitPrice * Convert.ToDecimal(i.Quantity) * Convert.ToDecimal((1 - i.Discount))):n2}", Info = g  };
            //var q1 = from i in dbContext.Order_Details
            //         group i by i.Order.OrderDate.Value.Year into g
            //         select new
            //         {
            //             年份 = g.Key,
            ...
            chart1.Series.Clear();
            chart1.ChartAreas.Add("FirstChart");
            chart1.Series.Add("每年銷售金額");
            chart1.ChartAreas[0].AxisY.Title = "銷售金額";
            ...
            foreach (var i in q)
            {
                chart1.Series[0].Points.AddXY(i.Year, i.每年銷售金額);
            }
        }
